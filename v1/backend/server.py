...
from database.config import get_db_connection, init_database
    ...
    def setup_routes(self):
        ...
        def handle_message(data):
            ...
            try:
                ...
                # Process with QnA agent using profile context
                response = self.qna_agent.analyze_with_context(message, context_data)
        ...
        @self.socketio.on('get_user_profiles')
        def handle_get_user_profiles(data):
            ...
            try:
                ...
                profiles = self.context_manager.list_user_profiles(user_id)
                ...
                emit('error', {'message': f'Failed to get profiles: {str(e)}'})
